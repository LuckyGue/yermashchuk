...
export class MainService {
  ...
  addToBuy(product: Product) {
    this.messageService.add({  severity: 'success', summary: 'Додано до кошика', detail: product.name });
    this.shoppingCart.push(product);
  }

  addToStar(product: Product) {
    this.messageService.add({  severity: 'success', summary: 'Додано до обраного', detail: product.name });
    this.stars.push(product);
  }

  getStars() {
    return Promise.resolve(this.stars);
  }

  getShop() {
    return Promise.resolve(this.shoppingCart);
  }
